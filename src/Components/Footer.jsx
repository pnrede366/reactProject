     ...
     <footer className="bg-dark text-light  p-3">
        <div className="row" >
            ...
            <div className="col-footer-2 col-10 col-lg-2 col-md-3 offset-md-1  offset-lg-2 col-sm-12 " >
                    ...
                    <div className="know-us">  <a className='nav-link'  href='./user/myaccount.php'>My Account</a></div>
            ...
            <div className="col-footer-3 col-10 col-lg-2 col-md-3 offset-md-1  offset-lg-2 col-sm-12 " >
                    ...
                    <div className="know-us"><a href="./sellersignup.php" className="nav-link">Sell on PrCart</a></div>
                    <div className="know-us"><a href="./loginseller.php" className="nav-link">LogIn seller</a></div>
                    <div className="know-us"><a href="./selleraccount.php" className="nav-link">Seller Account</a></div>
